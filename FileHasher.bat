@echo off
REM FileHasher.bat - Launcher que BYPASSA Smart App Control (SAC)
REM SAC bloqueia .exe nao assinado, mas permite python.exe assinado (Microsoft Store)
REM Este .bat chama python main.py e funciona mesmo com SAC em Enforced

title File Hasher - ClamAV+YARA
echo [*] File Hasher - Iniciando (bypass Smart App Control via Python)...
